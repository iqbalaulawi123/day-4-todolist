        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
            <div className="container-fluid">
                ...
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item">
                    <NavLink to="/todolist-redux" className={({isActive})=>isActive ? "nav-link active":"nav-link"}>
                        Todolist-redux (day 6-7)
                    </NavLink>
                    </li>
                    <li className="nav-item">
                    <NavLink to="/todolist-redux-persist" className={({isActive})=>isActive ? "nav-link active":"nav-link"}>
